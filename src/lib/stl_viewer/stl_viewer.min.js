...
function StlViewer(e, t) {
  ...
  ((this.error = null),
    ...
    (this.auto_rotate = !1),
    (this.mouse_zoom = !0),
    (this.load_three_files = o.get_opt("load_three_files", stl_viewer_script_path)),
    ...
    (this.set_drag_and_drop = function (e) {
      e
        ? (o.parent_element.addEventListener("dragover", o.handleDragOver),
          o.parent_element.addEventListener("drop", o.handleFileDrop))
        : (o.parent_element.removeEventListener("dragover", o.handleDragOver),
    ...
    (this.set_options = function () {
      ((o.canvas_width = o.get_opt("width", o.canvas_width)),
        ...
        (o.model_loaded_callback = o.get_opt("model_loaded_callback", o.model_loaded_callback)),
        (o.all_loaded_callback = o.get_opt("all_loaded_callback", o.all_loaded_callback)),
        (o.load_error_callback = o.get_opt("load_error_callback", o.load_error_callback)),
        (o.loading_progress_callback = o.get_opt("loading_progress_callback", o.loading_progress_callback)),
        (o.onmousedown_callback = o.get_opt("on_model_mousedown", o.onmousedown_callback)),
        o.onmousedown_callback || (o.onmousedown_callback = o.get_opt("on_model_mouseclick", null)),
        (o.send_no_model_click_event = o.get_opt("send_no_model_click_event", o.send_no_model_click_event)),
        ...
        o.zoom >= 0 ? (o.cameraz = o.zoom) : (o.cameraz = o.get_opt("cameraz", o.cameraz)),
    ...
    (this.add_from_existing_mesh = function (e) {
      (o.set_model_custom_props(e),
        ...
        e.mesh.geometry.boundingBox || e.mesh.geometry.computeBoundingBox(),
      ...
      ((t.onmessage = function (a) {
        switch (a.data.msg_type) {
          case o.MSGFROMWORKER_STL_LOADED:
            ...
            var i = o.vf_to_geo(a.data.vertices, a.data.faces, !!a.data.colors && a.data.colors, e.color);
            if (i) {
          ...
          case o.MSG2WORKER_ERROR:
            (o.models_count--,
              o.model_error("ERROR: " + a.data.data, o.load_error_callback),
              o.pre_loaded_ab_files &&
                e.filename &&
                o.pre_loaded_ab_files[e.filename] &&
                delete o.pre_loaded_ab_files[e.filename]);
    ...
    (this.set_grid = function (e, t, a) {
      if ((o.grid && o.scene.remove(o.grid), (o.grid = null), e)) {
        if ((t || (t = 2.5 * Math.max(Math.abs(o.maxx), Math.abs(o.minx))), t <= 0)) {
          var i = isNaN(window.innerHeight) ? window.clientHeight : window.innerHeight,
            n = isNaN(window.innerWidth) ? window.clientWidth : window.innerWidth;
          t = 0.8 * Math.min(i, n);
        }
        (a || (a = 10), (o.grid = new THREE.GridHelper(t, a)), o.scene.add(o.grid));
      }
    }),
    ...
    (this.set_zoom = function (e, t) {
      ...
      (o.zoom < 0 && (a = o.calc_z_for_auto_zoom()),
        o.camera.position.set(o.camera.position.x, o.camera.position.y, a));
      const i = o.minz,
        n = i < 0 ? -i + a : a - i;
      ((o.camera.far = Math.max(3e3 * n, o.camera.far)), o.camera.updateProjectionMatrix());
    }),
    (this.calc_z_for_auto_zoom = function (e) {
      e = e || 1.01;
      const t = new THREE.Box3(new THREE.Vector3(o.minx, o.miny, o.minz), new THREE.Vector3(o.maxx, o.maxy, o.maxz));
    ...
    (this.check_loading_status = function (e, t, a) {
      (e && (o.load_status[e.id] = { loaded: t, total: a, load_session: o.load_session }),
    ...
    (this.set_or_update_geo_edges = function (e, t, a) {
      if ((t && !a) || (e.edges && o.scene.remove(e.edges), (e.edges = null), t)) {
        ...
        if (((a = a || !1), !e.edges || a)) {
          ...
          ((e.edges = new THREE.LineSegments(new THREE.EdgesGeometry(n), o.edges_material)), (i = !0));
        }
        ((e.x || e.y || e.z) && e.edges.position.set(e.x ? e.x : 0, e.y ? e.y : 0, e.z ? e.z : 0),
    ...
    (this.set_model_custom_props = function (e) {
      ((e.units = e.units ? e.units : "mm"),
        ...
        e.color ? o.update_mesh_color(e.mesh, e.color, !1) : e.colors && o.update_mesh_color(e.mesh, "#FFFFFF", !0),
        (e.rotationx = e.rotationx ? e.rotationx : 0),
        (e.rotationy = e.rotationy ? e.rotationy : 0),
        (e.rotationz = e.rotationz ? e.rotationz : 0),
        (e.rotationx || e.rotationy || e.rotationz) && o.set_rotation(e.id, e.rotationx, e.rotationy, e.rotationz));
      ...
      ((e.scalex = a),
        ...
        void 0 !== e.opacity && this.set_material_opacity(e.mesh.material, e.opacity),
      ...
      null != e &&
        ("transparent" != t
          ? (e.traverse(function (e) {
            ...
            (e.material.vertexColors = o ? THREE.FaceColors : THREE.NoColors),
            o && !t && (t = "#FFFFFF"),
    ...
    (this.set_color = function (e, t) {
      ...
      a &&
        a.mesh &&
        (t.length < 6 ||
          ("#" != t.charAt(0) && (t = "#" + t), (a.color = t), o.update_mesh_color(a.mesh, t, !t && a.colors)));
    }),
    ...
    (this.set_bg_color = function (e) {
      ("transparent" == e ? this.renderer.setClearColor(0, 0) : this.renderer.setClearColor(e, 1), (o.bg_color = e));
    }),
    ...
    (this.set_opacity = function (e, t) {
      if (void 0 === o.models_ref[e]) return o.model_error("set_display - id not found: " + e);
      var a = o.models[o.models_ref[e]];
      a && ((a.opacity = t), this.set_material_opacity(a.mesh.material, t));
    }),
    ...
    (this.onmousedown = function (e) {
      ...
      switch (e.type) {
        case "touchstart":
          ...
          ((o.mouse.x = ((a.pageX - o.parent_element.offsetLeft) / o.parent_element.clientWidth) * 2 - 1),
            (o.mouse.y = (-(a.pageY - o.parent_element.offsetTop) / o.parent_element.clientHeight) * 2 + 1));
          break;
        case "dblclick":
          t = 11;
        default:
          ((o.mouse.x = ((e.clientX - o.parent_element.offsetLeft) / o.parent_element.clientWidth) * 2 - 1),
            (o.mouse.y = (-(e.clientY - o.parent_element.offsetTop) / o.parent_element.clientHeight) * 2 + 1));
      }
      ...
      if (i.length > 0) {
        ...
        o.onmousedown_callback && o.onmousedown_callback(i[0].object.model_id, e, i[0].distance, t);
      } else o.send_no_model_click_event && o.onmousedown_callback(null, e, 0, t);
    }),
    (this.is_empty = function (e) {
      return !e && 0 !== e;
    }),
    (this.set_model_units = function (e, t, a) {
      if (void 0 === o.models_ref[e]) return o.model_error("set_model_units - id not found: " + e);
      ...
      if (i && i.mesh) {
        ...
        1 != n && o.set_scale(i.id, i.scalex * n, i.scaley * n, i.scalez * n, !0);
      }
    }),
    ...
    (this.set_material_display = function (e, t, o) {
      switch (e.toLowerCase()) {
        case "wireframe":
          ...
          break;
        case "smooth":
          ((t.wireframe = !1), (t.flatShading = !1), o && (o.mergeVertices(), o.computeVertexNormals()));
          break;
        case "flat":
          ((t.wireframe = !1), (t.flatShading = !0), o && o.computeFlatVertexNormals());
      }
    }),
    (this.set_rotation = function (e, t, a, i, n) {
      ...
      if (l) {
        var s = n ? 1 : 0;
        (void 0 !== t && ((l.rotationx = t + l.mesh.rotation.x * s), (l.mesh.rotation.x = l.rotationx)),
          void 0 !== a && ((l.rotationy = a + l.mesh.rotation.y * s), (l.mesh.rotation.y = l.rotationy)),
          void 0 !== i && ((l.rotationz = i + l.mesh.rotation.z * s), (l.mesh.rotation.z = l.rotationz)),
          ...
          : e.orig_filename
            ...
            : e.temp_filename
              ...
              : e.local_file
                ...
                : e.filename && (e.filename instanceof File && (n = File.name), (n = e.filename)),
        !n && t ? "model_" + e.id + ".stl" : n ? (a && (n = o.basename(n)), n) : null
      );
    }),
      ...
      for (c = 0; c < p; c++)
        ((o = e.vertices[e.faces[c].a].x * t),
          ...
          (g +=
            ...
            o * l * _),
          (h =
            ((m = e.vertices[e.faces[c].a].distanceTo(e.vertices[e.faces[c].b]) * t) +
              (u = e.vertices[e.faces[c].b].distanceTo(e.vertices[e.faces[c].c]) * t) +
              (f = e.vertices[e.faces[c].c].distanceTo(e.vertices[e.faces[c].a]) * t)) /
            2),
    ...
    (this.get_model_info = function (e) {
      ...
      var a = t.mesh.geometry ? o.calc_volume_and_area(t.mesh.geometry, "inch" == t.units ? 1 / 25.4 : 1) : [0, 0, 0];
      return {
      ...
      return (
        ...
        Object.keys(o.models_ref).forEach(function (e) {
          ...
          if (a) l.filename = n.id + ".stl";
            ...
            (s && (l.filename = s), n.local_file && (l.local_file = n.local_file));
          }
          (n.x && (l.x = n.x),
            n.y && (l.y = n.y),
            n.z && (l.z = n.z),
            n.display && (l.display = n.display),
            (n.colors && "#ffffff" == n.color) || (n.color && (l.color = n.color)),
            ...
            void 0 === n.scale || a || (1 != n.scale && (l.scale = n.scale)),
            1 == n.scalex || a || (l.scalex = n.scalex),
            1 == n.scaley || a || (l.scaley = n.scaley),
            1 == n.scalez || a || (l.scalez = n.scalez),
            void 0 !== n.opacity && 1 != n.opacity && (l.opacity = n.opacity),
    ...
    (this.download_vsj = function (e) {
      ...
      (n >= 0 && (i = i.substring(0, n)),
        ...
        window.navigator.msSaveOrOpenBlob
          ...
          : ((a.download = i + ".vsj"), a.click(), URL.revokeObjectURL(a.href)));
    }),
    (this.load_vsj = function (e) {
      if (!e)
        return o.pre_loaded_vsj
          ? (stl_viewer.init_by_json(o.pre_loaded_vsj), (o.pre_loaded_vsj = null), !0)
          : o.model_error("load_vsj - invalid filename" + e, o.load_error_callback);
    ...
    (this.padend = function (e, t, o) {
      return (
        ...
        e.length > t
          ? String(e)
          : ((t -= e.length) > o.length && (o += o.repeat(t / o.length)), String(e) + o.slice(0, t))
      );
    }),
        ...
        if (a) {
          for (
            var i = new ArrayBuffer(84 + 50 * a.faces.length),
              n = new DataView(i),
              l =
                (new TextEncoder(), o.padend("Binary" + (t.colors ? " colored" : "") + " STL by viewstl.com", 80, " ")),
              s = 0;
            s < 80;
            s++
          )
            ...
            Object.keys(a.faces).forEach(function (e) {
              ...
              (n.setFloat32(r, _.x, !0),
                ...
                t.colors
                  ? n.setUint16(
                      r,
                      Math.ceil(31 * i.color.r) | (Math.ceil(31 * i.color.g) << 5) | (Math.ceil(31 * i.color.b) << 10),
                      !0,
                    )
                  : n.setUint16(r, 0, !0),
                (r += 2));
    ...
    (this.json_without_nulls = function (e) {
      return JSON.stringify(e).split(",null").join("").split("null,").join("");
    }),
    (this.get_vsb_blob = function () {
      ...
      return (
        ...
        Object.keys(t.files).forEach(function (a) {
          var i = o.get_model_filename(t.vsj.models[o.models_ref[t.files[a].id]], !0, !0);
      ...
      o.get_vsb_blob(e).then(function (t) {
        ...
        (n >= 0 && (i = i.substring(0, n)),
          ...
          window.navigator.msSaveOrOpenBlob
            ...
            : ((a.download = i + ".vsb"), a.click(), URL.revokeObjectURL(a.href)));
      });
    }),
    (this.load_vsb = function (e) {
      if (((o.pre_loaded_ab_files = []), (o.pre_loaded_vsj = null), e instanceof File))
      ...
      if (a && a.mesh) {
        ...
        (s >= 0 && (l = l.substring(0, s)),
          ...
          window.navigator.msSaveOrOpenBlob
            ...
            : ((n.download = l + ".stl"), n.click(), URL.revokeObjectURL(n.href)));
      }
    }),
    (this.get_model_mesh = function (e) {
      ...
      if (t && t.mesh) {
        var a = t.mesh.clone();
        return ((a.geometry = t.mesh.geometry.clone()), (a.material = t.mesh.material.clone()), a);
      }
    }),
    ...
    (this.do_resize = function () {
      if (o.parent_element) {
        var e = o.parent_element.getBoundingClientRect(),
          t = e.width,
          a = e.height;
        ((o.camera.aspect = t / a), o.camera.updateProjectionMatrix(), o.renderer.setSize(t, a));
      }
    }),
    (this.animation = []),
    ...
    (this.do_model_animation = function (e) {
      if (e.animation) {
        ...
        if (e.animation.exact) {
          ...
          if ((o.animation_next_exact(e, e.animation.exact, i), t >= e.animation.start_time + e.animation.exact.msec))
        ...
        switch (s) {
          ...
          case "rotationz":
            if (!n) {
              ...
              (void 0 === t.rotxtotal && (t.rotxtotal = t.rotationx - r.x),
                void 0 === t.rotytotal && (t.rotytotal = t.rotationy - r.y),
                void 0 === t.rotztotal && (t.rotztotal = t.rotationz - r.z),
                o.rotate(
                  e.id,
          ...
          case "scalez":
            l ||
              ...
              (t.scaley = t.scaley ? t.scaley : t.scale ? t.scale : null),
              (t.scalez = t.scalez ? t.scalez : t.scale ? t.scale : null),
              void 0 === t.scalextotal && (t.scalextotal = t.scalex - e.scalex),
              void 0 === t.scaleytotal && (t.scaleytotal = t.scaley - e.scaley),
              void 0 === t.scaleztotal && (t.scaleztotal = t.scalez - e.scalez),
              o.set_scale(
                e.id,
    ...
    (this.remove_model_animation = function (e, t, a) {
      (t && (e.animation.delta = null),
        ...
        e.animation.delta || e.animation.exact || ((e.animation = null), delete o.animation[e.id]));
    }),
    (this.animate_model = function (e, t) {
      ...
      if (a) {
        ...
        ((a.animation = JSON.parse(JSON.stringify(t))),
          a.animation.delta && (a.animation.delta.msec || (a.animation.delta.msec = 300)),
          a.animation.exact && (a.animation.exact.msec || (a.animation.exact.msec = 300)),
          (o.animation[e] = 1));
      }
    }),
    (this.init_done = !1),
    (this.init = function () {
      if (!o.init_done) {
        switch (
          ...
          (o.renderer = o.is_webgl
            ? new THREE.WebGLRenderer({ preserveDrawingBuffer: !0, alpha: !0 })
          ...
          (o.directionalLight = new THREE.DirectionalLight(16777215, 0.75)),
          ...
          case 1:
            ...
            break;
          default:
            ((o.controls = new THREE.OrbitControls(o.camera, o.renderer.domElement)),
      ...
      (o.set_bg_color(o.bg_color),
        ...
        o.camera_state ? o.set_camera_state(o.camera_state) : o.camera.position.set(o.camerax, o.cameray, o.cameraz),
        o.do_resize(),
    ...
    (this.set_auto_resize = function (e) {
      o.do_resize &&
        (window.removeEventListener("resize", o.do_resize), e && window.addEventListener("resize", o.do_resize));
    }),
    (this.vf_to_geo = function (e, t, a, n) {
      ...
      var l = [],
        s = [],
        r = e.length;
      for (i = 0; i < r; i++) l.push(new THREE.Vector3(e[i][0], e[i][1], e[i][2]));
      r = t.length;
      if (a)
        for (i = 0; i < r; i++) {
      ...
      else for (i = 0; i < r; i++) s.push(new THREE.Face3(t[i][0], t[i][1], t[i][2]));
    ...
    (this.set_geo_minmax = function (e) {
      ...
      if (t.boundingBox)
        ...
        for (
          var o = t.vertices, a = o[0].x, i = o[0].y, n = o[0].z, l = o[0].x, s = o[0].y, r = o[0].z, d = o.length;
          d--;
        )
          (o[d].x < a && (a = o[d].x),
            o[d].y < i && (i = o[d].y),
      ...
      (e.stopPropagation(),
        ...
        e.dataTransfer.files.length > 0
          ...
          : "string" == typeof e.dataTransfer.getData("Text") &&
            (o.add_model({ id: -1, filename: e.dataTransfer.getData("Text") }),
      ...
      if (
        ...
        for (i = e.children.length; i--; )
          "Mesh" === e.children[i].type &&
            (e.children[i].geometry.dispose(), e.children[i].material.dispose(), e.remove(e.children[i]));
        (Object.keys(o.models_ref).forEach(function (e) {
    ...
    (this.load_three = function (e) {
      ("string" != typeof o.load_three_files && (o.load_three_files = ""), (o.scripts_loader = new ScriptsLoader()));
      var t = [
        e + "three.min.js",
        e + "webgl_detector.js",
        e + "Projector.js",
        e + "CanvasRenderer.js",
        e + (0 == o.controls_type ? "OrbitControls.js" : "TrackballControls.js"),
      ];
      ...
      (o && (e.all_loaded_callback = o),
        Object.keys(t).forEach(function (o) {
          ...
          -1 == e.scripts_to_load.indexOf(a) &&
            (e.loading_scripts[a] || e.loaded_scripts[a] || e.scripts_to_load.push(t[o]));
        }),
        e.load_files());
    }),
...
((Number.isInteger =
  ...
  (init = (function () {
    if (!window.MSStream) {
      var e = document.currentScript.attributes.src.value,
        t = e.lastIndexOf("/");
