...
function download_from_local_xhr(a) {
  ...
  (get_progress &&
    ...
    (e.onreadystatechange = function (a) {
      4 == e.readyState && 200 == e.status && after_file_load(e.response);
    }),
    e.open("GET", a, !0),
    ...
    case MSG_DATA:
      ...
      (a.data.jszip_path && (jszip_path = a.data.jszip_path),
        a.data.data.local_file
          ...
          : a.data.data.filename && (filename = a.data.data.filename),
