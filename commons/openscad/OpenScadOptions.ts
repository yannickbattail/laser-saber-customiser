...
export class OpenScadOptions {
   ...
   * output directory for generated files
   */
  public randomOutput: string | null = null;
  /**
...
export class CameraEye {
  public eye: { x: number; y: number; z: number };
...
export class Option3mf {
  public color_mode: "model" | "none" | "selected_only";
  public unit: Unit;
  public color: string;
  public material_type: "color" | "basematerial";
  public decimal_precision: precision;
  public add_meta_data: "true" | "false";
